...
def get_data(filters):
    ...
    # If no status selected, fetch both draft and submitted
    ...
    for slip_data in slip_datas:
        ...
        # if not employee.custom_esi_consent:
        #     continue
        ...
        if slip_data.salary_structure:
            ...
            if salary_structure_assignment.base:
                ...
                row = {
                    ...
                    # "total_monthly_wages": round(gross_pay) if slip_data.custom_salary_structure_assignment else round(slip_data.gross_pay) ,
                    "total_monthly_wages": round(slip_data.gross_pay),
                    "reason": reason_code,
